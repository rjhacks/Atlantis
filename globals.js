...
var rows = 7;
var hexagonSide = 100;
var spotRadius = hexagonSide / 4;
var spotGrowCoreRadius = spotRadius / 2;
var spotDeadCoreRadius = spotRadius / 4;
var spotRotation = 30/180 - 10/180; // 30 degrees to corners, 10 degrees back
...
var spotDist = -(spotRadius + ((segmentRadius - spotRadius) / 2.2)); // distance from center of segment
